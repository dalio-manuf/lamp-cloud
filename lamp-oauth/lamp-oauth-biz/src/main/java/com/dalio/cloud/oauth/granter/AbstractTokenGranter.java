...
import com.dalio.cloud.model.enumeration.base.UserStatusEnum;
...
public abstract class AbstractTokenGranter implements TokenGranter {
     ...
     *
     * @param loginParam 登录参数
     * @return com.dalio.cloud.system.entity.tenant.DefUser
     * @author admin
     * @date 2022/10/5 12:38 PM
     * @create [2022/10/5 12:38 PM ] [admin] [初始创建]
     */
     ...
     *
     * @param defUser 用户信息
     * @return com.dalio.cloud.oauth.granter.AbstractTokenGranter.Employee
     * @author admin
     * @date 2022/10/5 12:38 PM
     * @create [2022/10/5 12:38 PM ] [admin] [初始创建]
     */
     ...
     *
     * @param employee 员工信息
     * @return com.dalio.cloud.oauth.granter.AbstractTokenGranter.Org
     * @author admin
     * @date 2022/10/5 12:40 PM
     * @create [2022/10/5 12:40 PM ] [admin] [初始创建]
     */
     ...
     * @create [2022/10/5 12:41 PM ] [admin] [初始创建]
     */
