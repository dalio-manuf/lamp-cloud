package com.dalio.cloud.areatest;
...
import static com.dalio.basic.utils.TreeUtil.getTreePath;
import static com.dalio.cloud.common.constant.DefValConstants.TREE_PATH_SPLIT;
...
public class CityParserImpl implements CityParser {
    ...
    private static final String COMMON_URL = "http://www.stats.gov.cn/sj/tjbz/tjyqhdmhcxhfdm/2022/";
...
//        return parseCity(parent, COMMON_URL + "64.html", 2);
    ...
    private List<DefArea> parseProvince(String url, int level) {
        ...
        byte[] bytes = get.charset(CityParserImpl.CHARSET).execute().bodyBytes();
