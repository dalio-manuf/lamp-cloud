...
public interface DefResourceService extends SuperCacheService<Long, DefResource> {
     ...
     * @return java.util.List<com.dalio.cloud.system.entity.application.DefResource>
     * @author admin
     * @date 2022/10/22 12:13 PM
     * @create [2022/10/22 12:13 PM ] [admin] [初始创建]
     */
     ...
     * @param idList 资源ID
     * @param types  资源类型
     * @return java.util.List<com.dalio.cloud.model.entity.system.SysResource>
     * @author admin
     * @date 2022/10/24 8:50 AM
     * @create [2022/10/24 8:50 AM ] [admin] [初始创建]
     */
     ...
     * @create [2021/6/5 9:33 上午 ] [admin] [初始创建]
     */
     ...
     * @create [2022/4/12 12:57 PM ] [admin] [初始创建]
     */
     ...
     * @create [2021/9/14 8:49 下午 ] [admin] [初始创建]
     */
     ...
     * @create [2022/10/13 5:08 PM ] [admin] [初始创建]
     */
     ...
     * @create [2021/9/18 2:50 下午 ] [admin] [初始创建]
     */
     ...
     *
     * @param id id
     * @return com.dalio.cloud.tenant.vo.result.tenant.DefResourceResultVO
     * @author admin
     * @date 2021/9/20 6:47 下午
     * @create [2021/9/20 6:47 下午 ] [admin] [初始创建]
     */
     ...
     * @create [2022/10/17 7:29 PM ] [admin] [初始创建]
     */
