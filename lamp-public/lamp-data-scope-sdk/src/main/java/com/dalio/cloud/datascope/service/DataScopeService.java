 ...
 * @create [2022/4/12 9:11 AM ] [admin] [初始创建]
 */
@Slf4j
@Service
...
public class DataScopeService {
     ...
     * @return com.dalio.cloud.datascope.entity.DefResourceDataScope
     * @author admin
     * @date 2022/10/20 10:26 AM
     * @create [2022/10/20 10:26 AM ] [admin] [初始创建]
     */
     ...
     * @create [2022/10/20 10:32 AM ] [admin] [初始创建]
     */
