...
import com.dalio.cloud.base.vo.query.user.BaseOrgPageQuery;
...
public interface BaseOrgService extends SuperCacheService<Long, BaseOrg> {
     ...
     * @return java.util.List<com.dalio.cloud.base.entity.user.BaseOrg>
     * @author admin
     * @date 2022/10/26 10:59 PM
     * @create [2022/10/26 10:59 PM ] [admin] [初始创建]
     */
     ...
     * @create [2022/10/26 10:29 PM ] [admin] [初始创建]
     */
     ...
     * @return com.dalio.cloud.base.entity.user.BaseOrg
     * @author admin
     * @date 2022/10/26 10:27 PM
     * @create [2022/10/26 10:27 PM ] [admin] [初始创建]
     */
