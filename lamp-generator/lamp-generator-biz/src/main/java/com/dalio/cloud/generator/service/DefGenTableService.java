...
public interface DefGenTableService extends SuperService<Long, DefGenTable> {
     ...
     * @param ids      表id
     * @param template 模板
     * @return com.dalio.basic.base.request.DownloadVO
     * @author admin
     ...
     * 获取生成项目的默认配置
     *
     * @return com.dalio.cloud.generator.vo.save.ProjectGeneratorVO
     * @author admin
     * @date 2022/4/5 6:13 PM
     * @create [2022/4/5 6:13 PM ] [admin] [初始创建]
     */
     ...
     * @create [2022/4/15 10:27 AM ] [admin] [初始创建]
     */
     ...
     * 获取默认的文件覆盖策略
     *
     * @return java.util.Map<java.lang.String, com.dalio.cloud.generator.enumeration.FileOverrideStrategyEnum>
     * @author admin
     * @date 2022/4/15 10:27 AM
     * @create [2022/4/15 10:27 AM ] [admin] [初始创建]
     * @update [2022/4/15 10:27 AM ] [admin] [变更描述]
     */
     ...
     *
     * @param idList idList
     * @return java.util.List<com.dalio.cloud.generator.vo.result.DefGenTableResultVO>
     * @author admin
     * @date 2022/6/13 9:43 AM
     * @create [2022/6/13 9:43 AM ] [admin] [初始创建]
     * @update [2022/6/13 9:43 AM ] [admin] [变更描述]
     */
     ...
     * @create [2022/6/14 8:56 PM ] [admin] [初始创建]
     * @update [2022/6/14 8:56 PM ] [admin] [变更描述]
     */
